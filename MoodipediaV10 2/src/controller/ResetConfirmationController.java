...
public class ResetConfirmationController implements Initializable {
    ...
    @FXML
    public void resetAccount(ActionEvent e) throws IOException {
       
        resetAccountLabel.setText("Account has been reset!");
        ac.getFn().setText("");
        ac.getLn().setText("");
        ac.getAge().setText("");
        ac.getAccountGender().setText("");
        ac.getAccountWeight().setText("");
        ac.getHeight().setText("");
